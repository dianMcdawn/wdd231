...
const membershipDetails = document.querySelector('#memberships-desc');
const membershipDetailsTitle = document.querySelector('#memberships-desc h2');
const membershipDetailsInfo = document.querySelector('#memberships-desc p');
const membershipDetailsClose = document.querySelector('#memberships-desc #dialog-close');
...
function showStuff(x){
    membershipDetailsTitle.innerHTML = x.membershipName;
